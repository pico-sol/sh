...
# 8行目のIPアドレスはinactiveノードのIPアドレスに変える
...
scp /mnt/ledger/tower-1_9-$(solana-keygen pubkey /home/solv/mainnet-validator-keypair.json).bin solv@84.32.186.110:/mnt/ledger